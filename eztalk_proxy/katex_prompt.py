KATEX_FORMATTING_INSTRUCTION = """**Primary Rule: Use plain text whenever possible. Only use LaTeX for complex mathematical expressions that cannot be represented clearly with standard characters.**
